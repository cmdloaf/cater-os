...
export default function DashboardPage() {
  ...
  return (
    <div className="relative -mx-4 -mt-6 px-4 pb-5 pt-6 lg:-mx-8 lg:-mt-8 lg:px-8 lg:pt-8">
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4 lg:col-span-2">
          ...
          {/* Stat cards — the accent graphic is scoped to this wrapper only
              (nested inside the lg:col-span-2 left column, anchored to its
              own right edge), so it structurally cannot reach the calendar
              column and reads as a pop of color behind just the Confirmed
              card, not a wash across the whole hero. */}
          <div className="relative isolate">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -top-5 right-0 -z-10 hidden h-40 w-64 overflow-hidden rounded-full sm:block"
              style={{
                backgroundImage: "url(/dashboard-accent.svg)",
                backgroundSize: "320% 320%",
                backgroundPosition: "84% 80%",
                WebkitMaskImage:
